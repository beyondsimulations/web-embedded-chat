...
A Rust-based chat backend that proxies messages to any OpenAI-compatible API, with built-in telemetry logging to PostgreSQL and an analytics dashboard. Built for university lecture deployments.
...
- **Privacy by design** -- user IDs are SHA-256 hashes of (IP + semester), making cross-semester tracking impossible
